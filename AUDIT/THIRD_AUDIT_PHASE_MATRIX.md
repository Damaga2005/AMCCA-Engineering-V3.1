...
| **8** | Research, claims, sources | **PASS** | `SPEC/06`, `SPEC/23`, `SPEC/24` | `src/AMCCA.Core/Security/SsrfValidator.cs`, `SafeHttpClientFactory.cs`, `src/AMCCA.Core/Research/ResearchService.cs`, `src/AMCCA.Core/Research/ResearchScraper.cs` | `SsrfProductionPathTests.cs`, `SsrfPipelineEnforcementContractTests.cs` |
