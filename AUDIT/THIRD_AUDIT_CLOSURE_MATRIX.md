...
| **AUDIT-005** | Handler anti-SSRF desconectado del pipeline de scraping | CRITICAL | `CreateSafeSocketsHttpHandler` no se inyectaba en el cliente HTTP de `ResearchScraper`. | `src/AMCCA.Core/Research/ResearchScraper.cs`, `src/AMCCA.Core/Security/SafeHttpClientFactory.cs` | `tests/AMCCA.Core.Tests/OutboundSsrfEnforcementTests.cs` (7 tests). | `08207e4` | **CLOSED** |
